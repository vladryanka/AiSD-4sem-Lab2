...
int main() {
	const string test ="it is test string";
	const int length = test.length();
	cout << "Testing string: " << test<< endl;
	AlgorithmHaffman check;
	check.Algorithm(test, length);
	cout << "Table of Frequency and Codes:" << endl;
	check.printTableOfFrequencyAndCodes();
	string resultOfCoding = check.resultOfCoding(test);
	cout << "Result of coding: " << resultOfCoding << endl;
	cout << "Result of encoding: " << check.resultOfDecoding(resultOfCoding) << endl;
	cout << "Encoded string size = " << check.encodedSize(resultOfCoding) << endl;
	cout << "Original string memory: " << length * 8 << endl;
	float result = length * 8 / check.encodedSize(resultOfCoding);
	cout << "Compression ratio " << result << endl;
	cout << endl;
